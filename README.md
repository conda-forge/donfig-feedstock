About donfig-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/donfig-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4535&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/donfig-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `donfig` can be installed with `conda`:
...
```
mamba install donfig
```

It is possible to list all of the versions of `donfig` available on your platform with `conda`:
...
```
mamba search donfig --channel conda-forge
```
...
mamba repoquery search donfig --channel conda-forge

# List packages depending on `donfig`:
mamba repoquery whoneeds donfig --channel conda-forge

# List dependencies of `donfig`:
mamba repoquery depends donfig --channel conda-forge
```
